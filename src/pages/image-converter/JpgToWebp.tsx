    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-xl mx-auto bg-card shadow-lg rounded-lg p-8 text-center">
          ...
          <h1 className="text-2xl font-bold mb-2">JPG to WEBP Converter</h1>
          <p className="mb-6 text-muted-foreground">
            Convert JPG images to WEBP format instantly, right in your browser.
          </p>
          ...
          {outputUrl && (
            <div className="mt-6">
              <div className="font-semibold mb-1">WEBP Preview:</div>
              <img
                src={outputUrl}
